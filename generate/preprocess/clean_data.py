...
with open('/home/aa043/sea/data/td/ours/v2/generate/draft_ast_seqs.txt', 'r', encoding='utf-8') as f:
...
with open('/home/aa043/sea/data/td/ours/v2/generate/ast_seqs.txt', 'w', encoding='utf-8') as f:
    for seq in clean_seqs:
        f.write(seq + '\n')

# Clean comments
# Read from comments file
with open("/home/aa043/sea/data/td/ours/v2/generate/draft_comments.txt", "r", encoding='utf-8') as f:
