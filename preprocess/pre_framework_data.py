from support_functions import retrieve_data, combine_data, tokenize, DataObject, data_shapes, shape_info, write_to_disk
...
data_path = "/home/aa043/sea/data/td/v3/"  # Path to the data txt files on disk.
...
# Combine data to remove further duplicates caused by data formatting
...
# Build cross-testing set, and shuffle to avoid potential order biases
ct_set = pos_data + neg_ct
ct_set = sample(ct_set, k=len(ct_set))
# Prepare for separating CV & tune
...
# Prepare for pre-training object
